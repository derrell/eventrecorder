    ...
    */
    members: {
      ...
      _stopResizeHeader: function _stopResizeHeader() {
        ...
        this.setCursor(null); // handle edit cell if available
      ...
      startEditing: function startEditing() {
        ...
        if (!this.isEditing() && col != null && tableModel.isColumnEditable(col)) {
          ...
          if (this._cellEditor === null) {
            ...
            this._cellEditor.setUserBounds(0, 0, size.width, size.height); // prevent tap event from bubbling up to the table
...
//# sourceMappingURL=Scroller.js.map?dt=1556283831126