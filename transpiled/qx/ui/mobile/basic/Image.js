    ...
    members: {
      ...
      */
      _findHighResolutionSource: function _findHighResolutionSource(lowResImgSrc) {
        var pixelRatioCandidates = qx.ui.mobile.basic.Image.PIXEL_RATIOS; // Calculate the optimal ratio, based on the rem scale factor of the application and the device pixel ratio.
        ...
        var hiResImgSrc; // Search for best img with a higher resolution.
...
//# sourceMappingURL=Image.js.map?dt=1556283828182