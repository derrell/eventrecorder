    ...
    members: {
      ...
      load: function load(apidata) {
        ...
        setTimeout(function () {
          ...
          var end = new Date();
          {
            _this.debug("Time to build data tree: " + (end.getTime() - start.getTime()) + "ms");
          }
          var start = new Date();
          ...
          var end = new Date();
          {
            _this.debug("Time to update tree: " + (end.getTime() - start.getTime()) + "ms");
          }
          setTimeout(function () {
            // Handle bookmarks
...
//# sourceMappingURL=Controller.js.map?dt=1556283835411