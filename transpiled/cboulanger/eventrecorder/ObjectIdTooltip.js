    ...
    members: {
      ...
      init: function init() {
        ...
        this.addGlobalEventListener(function (target, event) {
          ...
          var data = typeof event.getData == "function" ? event.getData() : null; // selections are arrays
          ...
          var msg = data !== null ? "==> ID ".concat(id, ": event '").concat(type, "' was fired with data ").concat(data) : "==> ID ".concat(id, ": event ").concat(type, " was fired.");
...
//# sourceMappingURL=ObjectIdTooltip.js.map?dt=1556283811087