          ...
          case "change":
            {
              ...
              if (isModelSelection) {
                var _owner = target.getQxOwner();

                var ownerId = qx.core.Id.getAbsoluteIdOf(_owner);

                var model = _owner.getModel();
          ...
          case "changeSelection":
            {
              if (target instanceof qx.ui.treevirtual.TreeVirtual) {
                ...
                lines.push("set-table-selection ".concat(id, " ").concat(_row, ",").concat(_row));
              }
...
//# sourceMappingURL=Recorder.js.map?dt=1556283835065